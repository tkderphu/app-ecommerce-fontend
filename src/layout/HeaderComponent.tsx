                            ...
                            <ModalComponent
                                ...
                                body={
                                    <Fragment >
                                        ...
                                        <div >
                                            <div><strong>Trạng thái đơn hàng được cập nhật</strong></div>
                                            <div className='d-flex mt-4 justify-content-around'>
                                                    <div><a href='/my-orders/{{orderId}}'><strong>Mã đơn hàng: </strong>{"orderId"}</a></div>
                                                    <div><strong>Trạng thái: </strong>{"orderStatus"}</div>
                                                    <div ><strong>Ngày tạo: </strong>{"d"}</div>
                                            </div>
                                        </div>
                                        <hr/>
                                    </Fragment>
